...
const Profile = ({user}) => {
  ...
  const handleFileInputChange = async (event) => {
    ...
    if (file) {
      try {
        ...
        console.log('Uploaded file data:', data); // Debug: log uploaded file data
       
        setSelectedFile(data.url);
        setFormData({ ...formData, photo: data.url });
      } catch (error) {
        console.error('File upload error:', error); // Debug: log file upload error
  ...
  const submitHandler = async (event) => {
    ...
    try {
      console.log('Form data before submission:', formData); // Debug: log form data
      ...
      console.log('Response data:', resData); // Debug: log response data
      ...
      console.error('Signup error:', error); // Debug: log signup error
