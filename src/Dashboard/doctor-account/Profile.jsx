...
const Profile = ({doctorData}) => {
    ...
    useEffect(()=>{
        setFormData({
            ...
            ticketPrice:doctorData?.ticketPricee,
    ...
    const deleteItem = (key, index, event) =>{
        setFormData(prevFormData =>({
            ...prevFormData,
    ...
    const addQualification = (e) => {
        ...
        addItem('qualifications', {
            startingDate:'', endingDate:'', degree:'PHD', university:'UST'
        })
    }
    ...
    const addExperience = (e) => {
        e.preventDefault();
        addItem('experiences', {
            startingDate:'', endingDate:'',position:'Senior Surgeon', hospital:'JBL Hospital'
        })
    }
    ...
    const addTimeSlot = (e) => {
        e.preventDefault();
        addItem('timeSlots', {
            day:'Sunday', startingTime:'09:00',endTime:'05:00'
        })
    }
    ...
    <div>
        ...
        <form>
            ...
            <div className="mb-5">
                ...
                <input type="email" name="email" value={formData.email} onChange={handleInputChange} placeholder="Email" className="form__input" readOnly aria-readonly disabled/>
            </div>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-5 mt-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="university" name="university" value={item.university} className="form__input" onChange={e=>handleQualificationChange(e, index)}/>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5 mt-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="time" name="endTime" value={item.endTime} className="form__input " onChange={e=>handleTimeSlotChange(e, index)}/>
                                    </div>
            ...
            <div className="mb-5">
                ...
                <textarea name="about" rows={5} value={formData.about} placeholder="write something about you" onChange={handleInputChange} className="form__input"></textarea>
            </div>
