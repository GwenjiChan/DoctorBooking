        ...
        <div className='md:col-span-2'>
          <div className='flex items-center gap-5'>
            ...
            <div className='mt-[50px] border-b border-solid border-[#006ff34]'>
              ...
              className={`${tab=='about' && 'border-b border-solid boder-primaryColor'} py-2 px-5 mr-5 text-16px leading-7 text-headingColor font-semibold`}>About</button>
              <button 
              onClick={()=>setTab('feedback')}
              className={`${tab=='feedback' && 'border-b border-solid boder-primaryColor'} py-2 px-5 mr-5 text-16px leading-7 text-headingColor font-semibold`}>Feedback</button>
            </div>
